...
import { SiGit, SiGithub, SiTypescript, SiExpress, SiMongodb, SiMysql } from 'react-icons/si';
...
export const SkillsData: Skill[] = [
    ...
    { id: 9, name: 'MongoDB', icon: <SiMongodb className="text-[#47A248] text-5xl" /> },
    { id: 10, name: 'Java', icon: <FaJava className="text-[#ED8B00] text-5xl" /> },
    { id: 11, name: 'Go', icon: <FaGolang className="text-[#00ADD8] text-5xl" /> },
    { id: 12, name: 'SQL', icon: <SiMysql className="text-[#4479A1] text-5xl" /> },
    { id: 13, name: 'Git', icon: <SiGit className="text-[#F05032] text-5xl" /> },
    { id: 14, name: 'GitHub', icon: <SiGithub className="text-[#181717] text-5xl" /> },
    { id: 15, name: 'Linux', icon: <FcLinux className="text-5xl" /> },
    { id: 16, name: 'AWS', icon: <FaAws className="text-[#FF9900] text-5xl" /> },
];